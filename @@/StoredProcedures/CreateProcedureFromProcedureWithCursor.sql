...
CREATE PROC [@@].[CreateProcedureFromProcedureWithCursor]
...
AS
BEGIN
	IF [@Info].[isProcedure](@ObjectName) = 0 RETURN -1

	DECLARE @Template NVARCHAR (MAX)=''
	EXECUTE [@@].[_getObjectTemplate] @ObjectName,@Template OUTPUT,@OnlyBeginEndBlock=1
  ...
  ,@BodyProcedureTemplateName=@BodyProcedureTemplateName
  ,@CreateManyProcedures=@CreateManyProcedures
  ,@Print=@Print
